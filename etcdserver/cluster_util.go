...
// cluster version in the range of [MinClusterVersion, MaxClusterVersion] and no known members has a cluster version
// out of the range.
// The MaxClusterVersion is 1 minor version higher to support downgrade.
