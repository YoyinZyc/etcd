...
type ClusterInfoType int32

const (
	ClusterInfoType_ClusterVersion ClusterInfoType = 0
)

var ClusterInfoType_name = map[int32]string{
	0: "ClusterVersion",
}
var ClusterInfoType_value = map[string]int32{
	"ClusterVersion": 0,
}

func (x ClusterInfoType) String() string {
	return proto.EnumName(ClusterInfoType_name, int32(x))
}
func (ClusterInfoType) EnumDescriptor() ([]byte, []int) { return fileDescriptorRaftInternal, []int{0} }
...
type InternalRaftRequest struct {
	...
	ClusterInfoChange        *ClusterInfoChangeRequest        `protobuf:"bytes,1300,opt,name=cluster_info_change,json=clusterInfoChange" json:"cluster_info_change,omitempty"`
}
...
type ClusterInfoChangeRequest struct {
	// Type is cluster info type to change
	Type ClusterInfoType `protobuf:"varint,1,opt,name=type,proto3,enum=etcdserverpb.ClusterInfoType" json:"type,omitempty"`
	// Value is updated value of specific type
	Value []byte `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty"`
}

func (m *ClusterInfoChangeRequest) Reset()         { *m = ClusterInfoChangeRequest{} }
func (m *ClusterInfoChangeRequest) String() string { return proto.CompactTextString(m) }
func (*ClusterInfoChangeRequest) ProtoMessage()    {}
func (*ClusterInfoChangeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptorRaftInternal, []int{4}
}

type ClusterInfoChangeResponse struct {
}

func (m *ClusterInfoChangeResponse) Reset()         { *m = ClusterInfoChangeResponse{} }
func (m *ClusterInfoChangeResponse) String() string { return proto.CompactTextString(m) }
func (*ClusterInfoChangeResponse) ProtoMessage()    {}
func (*ClusterInfoChangeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptorRaftInternal, []int{5}
}
...
func init() {
	...
	proto.RegisterType((*ClusterInfoChangeRequest)(nil), "etcdserverpb.ClusterInfoChangeRequest")
	proto.RegisterType((*ClusterInfoChangeResponse)(nil), "etcdserverpb.ClusterInfoChangeResponse")
	proto.RegisterEnum("etcdserverpb.ClusterInfoType", ClusterInfoType_name, ClusterInfoType_value)
}
...
func (m *InternalRaftRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ClusterInfoChange != nil {
		dAtA[i] = 0xa2
		i++
		dAtA[i] = 0x51
		i++
		i = encodeVarintRaftInternal(dAtA, i, uint64(m.ClusterInfoChange.Size()))
		n28, err := m.ClusterInfoChange.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n28
...
func (m *ClusterInfoChangeRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ClusterInfoChangeRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ClusterInfoChangeResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ClusterInfoChangeResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ClusterInfoChangeRequest) Size() (n int) {
	var l int
	_ = l
	if m.Type != 0 {
...
func (m *ClusterInfoChangeResponse) Size() (n int) {
	var l int
	_ = l
	return n
}
...
func (m *InternalRaftRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1300:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ClusterInfoChange", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ClusterInfoChange == nil {
				m.ClusterInfoChange = &ClusterInfoChangeRequest{}
			}
			if err := m.ClusterInfoChange.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ClusterInfoChangeRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ClusterInfoChangeRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ClusterInfoChangeRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= (ClusterInfoType(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *ClusterInfoChangeResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ClusterInfoChangeResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ClusterInfoChangeResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
var fileDescriptorRaftInternal = []byte{
	...
	,
}
